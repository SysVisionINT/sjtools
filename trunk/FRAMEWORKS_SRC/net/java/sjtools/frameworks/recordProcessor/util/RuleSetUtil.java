...
public class RuleSetUtil {
	...
	public static RuleSet getRuleSet(RuleSets ruleSets, String name) throws RuleSetError {
		RuleSet ruleSet = null;
		boolean found = false;

		for (Iterator iterator = ruleSets.getRuleSets().iterator(); iterator.hasNext();) {
