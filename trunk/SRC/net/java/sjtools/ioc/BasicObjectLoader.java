...
public abstract class BasicObjectLoader implements ObjectLoader {
	private static Log log = LogFactory.getLog(BasicObjectLoader.class);

	private ClassLoader classLoader = null;

	public BasicObjectLoader() {
		classLoader = Thread.currentThread().getContextClassLoader();
	}

	public BasicObjectLoader(ClassLoader cl) {
		classLoader = cl;
	}
