...
public class CalendarFormater implements ObjectFormater {
	private static final String FORMAT = "sjtools.formater.CalendarFormater.format";

	public String format(Object obj, boolean includePackage) {
		if (obj instanceof Calendar) {
			Calendar calendar = (Calendar) obj;
			
			SuperDate superDate = new SuperDate(calendar);
