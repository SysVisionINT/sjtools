...
import net.java.sjtools.cache.CacheEntry;
import net.java.sjtools.cache.dynamic.error.CacheUnavailable;
...
import net.java.sjtools.time.timer.SuperTimerTask;

public class Cache extends SuperTimerTask {
